...
receiving and putaway line, growing into a full distribution centre with an upstream
factory and a transport network, stays synchronised with a simulated device fleet
...
Fourteen sections, each an implementation contract. An implementer builds from one of
...
| [Variability and faults](design/variability-and-faults.md) | The stochastic model and the labelled fault catalog               |
...
| [Sensor catalog](design/sensor-catalog.md)                 | The catalog schema and eighty implemented sensor types            |
