...
| C11    | Licence records and SBOM entries for the four vendored browser assets (two subsetted fonts, three.js, DuckDB-Wasm) and for the test-only browser tooling.                                                          | The audit and allowlist tooling.                                                       |
