...
No measured performance numbers exist for the system this repository models.
The scaling curve, the eval accuracy, and the quickstart timing are all unfilled
markers, and they stay unfilled until a recorded run produces them. The build
tooling is the one exception: hook startup is measured, and those figures live
