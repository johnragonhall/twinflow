#!/bin/sh
# The behavioural half of TWF-RNG-002, and the Phase 0a form of gate DET-3.
#
# CPython randomises string hashing per process unless PYTHONHASHSEED is fixed,
...
if [ "$a" != "$b" ]; then
  printf '\033[31mFAIL\033[0m TWF-RNG-002 behavioural check\n' >&2
...
printf '\033[32mPASS\033[0m TWF-RNG-002 behavioural check: %s\n' "$a"
